...
/**
 * <a name="DAAL-CLASS-DATA_MANAGEMENT__DATA__HOMOGENNUMERICTABLEARRAYIMPL"></a>
...
class HomogenNumericTableArrayImpl extends HomogenNumericTableImpl {
    ...
    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,double[],long,long,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, double[] data, long nFeatures, long nVectors, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Double.class, data, nFeatures, nVectors, featuresEqual);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,float[],long,long,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, float[] data, long nFeatures, long nVectors, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Float.class, data, nFeatures, nVectors, featuresEqual);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,long[],long,long,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, long[] data, long nFeatures, long nVectors, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Long.class, data, nFeatures, nVectors, featuresEqual);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,int[],long,long,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, int[] data, long nFeatures, long nVectors, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Integer.class, data, nFeatures, nVectors, featuresEqual);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,double[],long,long,double,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, double[] data, long nFeatures, long nVectors, double constValue, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Double.class, data, nFeatures, nVectors, featuresEqual);
        assign (constValue);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,float[],long,long,float,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, float[] data, long nFeatures, long nVectors, float constValue, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Float.class, data, nFeatures, nVectors, featuresEqual);
        assign (constValue);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,long[],long,long,long,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, long[] data, long nFeatures, long nVectors, long constValue, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Long.class, data, nFeatures, nVectors, featuresEqual);
        assign (constValue);
    }

    /** @copydoc HomogenNumericTable::HomogenNumericTable(DaalContext,int[],long,long,int,DataDictionary.FeaturesEqual) */
    public HomogenNumericTableArrayImpl(DaalContext context, int[] data, long nFeatures, long nVectors, int constValue, DataDictionary.FeaturesEqual featuresEqual) {
        super(context);
        initialize(context, Integer.class, data, nFeatures, nVectors, featuresEqual);
        assign (constValue);
    }
    ...
    private void initialize(DaalContext context, Class<? extends Number> cls, Object data, long nFeatures, long nVectors, DataDictionary.FeaturesEqual featuresEqual) {
        type = cls;
        cObject = newJavaNumericTable(nFeatures, nVectors, NumericTable.StorageLayout.aos, featuresEqual,
                                      SerializationTag.SERIALIZATION_JAVANIO_HOMOGEN_NT_ID);
        dict = new DataDictionary(context, nFeatures, cGetCDataDictionary(cObject));
        if (featuresEqual == DataDictionary.FeaturesEqual.equal) {
    ...
    protected void onUnpack(DaalContext context) {
        if (cObject == 0) {
            cObject = newJavaNumericTable(nJavaFeatures, nJavaVectors, NumericTable.StorageLayout.aos, serializedFeaturesEqual,
                                          SerializationTag.SERIALIZATION_JAVANIO_HOMOGEN_NT_ID);
        }
        dict = new DataDictionary(context, nJavaFeatures, cGetCDataDictionary(cObject));
        if (dict.getFeaturesEqual() == DataDictionary.FeaturesEqual.equal) {
            dict.setFeature(type, 0);
        } else {
