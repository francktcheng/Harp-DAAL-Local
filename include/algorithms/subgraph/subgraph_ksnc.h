...
#ifndef __SUBGRAPH_KSNC_H__
#define __SUBGRAPH_KSNC_H__
...
{
/** @defgroup subgraph_knl_snc Distri
* @ingroup subgraph_without_pivoting
* @{
*/
/**
 * <a name="DAAL-CLASS-ALGORITHMS__subgraph__BATCHCONTAINER"></a>
 * \brief Provides methods to run implementations of the subgraph algorithm in the SNC processing mode of KNL
 *
...
public:
    ...
    /**
     * Computes the result of the subgraph algorithm in the Knl SNC processing mode
     */
...
/**
 * <a name="DAAL-CLASS-ALGORITHMS__subgraph__knl_snc"></a>
 * \brief Computes the results of the subgraph algorithm in the knl_snc processing mode.
