...
template<> void updateMF<DAAL_FPTYPE, avx512_mic>(DAAL_FPTYPE* WMat, DAAL_FPTYPE* HMat, DAAL_FPTYPE* workV, int* seq, int idx, const long dim_r, const DAAL_FPTYPE rate, const DAAL_FPTYPE lambda)
{
...
template<> void computeRMSE<DAAL_FPTYPE, avx512_mic>(DAAL_FPTYPE *WMat,DAAL_FPTYPE *HMat, DAAL_FPTYPE* testV, DAAL_FPTYPE* testRMSE, int idx, const long dim_r)
{
