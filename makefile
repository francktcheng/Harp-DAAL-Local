...
daaldep.lnx32e.mkl.thr := $(VMLDIR.libia)/$(plib)daal_mkl_thread.$a
daaldep.lnx32e.mkl.seq := $(VMLDIR.libia)/$(plib)daal_mkl_sequential.$a
...
daaldep.lnx32.mkl := $(VMLDIR.libia)/$(plib)daal_vmlipp_core.$a
daaldep.lnx32.vml := 
daaldep.lnx32.ipp := 
...
daaldep.win32e.mkl := $(VMLDIR.libia)/$(plib)daal_vmlipp_core.$a
daaldep.win32e.vml := 
daaldep.win32e.ipp := 
daaldep.win32e.rt  := -LIBPATH:$(TBBDIR.libia) tbb.lib tbbmalloc.lib libcpmt.lib libcmt.lib

daaldep.win32.mkl.thr := $(VMLDIR.libia)/daal_mkl_thread.$a
daaldep.win32.mkl.seq := $(VMLDIR.libia)/daal_mkl_sequential.$a
daaldep.win32.mkl := $(VMLDIR.libia)/$(plib)daal_vmlipp_core.$a
daaldep.win32.vml := 
daaldep.win32.ipp := 
daaldep.win32.rt  := -LIBPATH:$(TBBDIR.libia) tbb.lib tbbmalloc.lib libcpmt.lib libcmt.lib

daaldep.mac32e.mkl.thr := $(VMLDIR.libia)/$(plib)daal_mkl_thread.$a    
daaldep.mac32e.mkl.seq := $(VMLDIR.libia)/$(plib)daal_mkl_sequential.$a
daaldep.mac32e.mkl := $(VMLDIR.libia)/$(plib)daal_vmlipp_core.$a
daaldep.mac32e.vml := 
daaldep.mac32e.ipp := 
daaldep.mac32e.rt  := -L$(TBBDIR.libia) -ltbb -ltbbmalloc $(daaldep.mac32e.rt.$(COMPILER))

daaldep.mac32.mkl.thr := $(VMLDIR.libia)/$(plib)daal_mkl_thread.$a    
daaldep.mac32.mkl.seq := $(VMLDIR.libia)/$(plib)daal_mkl_sequential.$a
daaldep.mac32.mkl := $(VMLDIR.libia)/$(plib)daal_vmlipp_core.$a
daaldep.mac32.vml := 
daaldep.mac32.ipp := 
...
spat = %.java %.cpp %.h %.txt %.csv %.htm %.py
...
$(WORKDIR.lib)/$(thr_tbb_y): $(THR_TBB.objs_y) $(daaldep.mkl.thr) $(if $(OS_is_win),$(THR.tmpdir_y)/dll_tbb.res,) ; $(LINK.DYNAMIC) ; $(LINK.DYNAMIC.POST)
...
$(WORKDIR.lib)/$(thr_seq_y): $(THR_SEQ.objs_y) $(daaldep.mkl.seq) $(if $(OS_is_win),$(THR.tmpdir_y)/dll_seq.res,) ; $(LINK.DYNAMIC) ; $(LINK.DYNAMIC.POST)
...
# Top level targets
#===============================================================================
daal:    _daal _daal_jj _release _release_doc $(if $(PLAT_is_lnx32e),_release_p)
...
#----- releasing static/dynamic TBB libraries
define .release.t
