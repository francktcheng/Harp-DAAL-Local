...
public:
    ...
    */
	 ...
	 */
    int getSerializationTag() const DAAL_C11_OVERRIDE  { return SERIALIZATION_MF_SGD_RESULT_ID; }
...
public:
	 ...
	 */
    int getSerializationTag() const DAAL_C11_OVERRIDE  { return SERIALIZATION_MF_SGD_DISTRI_PARTIAL_RESULT_ID;}
